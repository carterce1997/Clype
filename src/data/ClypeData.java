...
public abstract class ClypeData implements Serializable {
	...
	/**
	 * A constructor taking a connection type, that automatically sets username to "Anon".
	 * @param type
	 */
	...
	/**
	 * A default constructor that sets username to "Anon" and sets connection type to list all users.
	 */
	public ClypeData() {
		this( "Anon", LIST_USERS );
	}
	 ...
	 * @param inputStringToEncrypt The message to encrypt.
	 * @param key The encryption key.
	 ...
	 * @param inputStringToDecrypt The message to decrypt.
	 * @param key The encryption key.
