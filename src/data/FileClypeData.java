...
public class FileClypeData extends ClypeData {
	...
	/**
	 * A default constructor that sets default userName to "Anon", fileName to "", fileContents to null, and connection type to 0.
	 */
	...
	/**
	 * Reads file contents into the class from the given filename, and encrypts them.
