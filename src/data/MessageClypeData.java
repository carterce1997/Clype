...
public class MessageClypeData extends ClypeData {
	...
	/**
	 * A constructor to initialize the class. Takes the user's username, message, and connection type.
	...
	/**
	 * A delegating default constructor. Defaults to username "Anon", connection type 0, and no message data.
	 */
	...
	/**
	 * A constructor that initializes the class by encrypting the message with a key.
	 * @param userName The client username.
